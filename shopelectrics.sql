...
--
-- Host: localhost
-- Generation Time: Jun 12, 2025 at 06:34 PM
...
CREATE TABLE `addresses` (
  ...
  `type` enum('shipping','billing','both') COLLATE utf8mb4_vietnamese_ci DEFAULT 'both',
  `first_name` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `last_name` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `company` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `phone` varchar(20) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `address_line1` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `address_line2` varchar(255) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  ...
  `postal_code` varchar(20) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `country` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT 'Vietnam',
...
CREATE TABLE `coupons` (
  ...
  `description` text COLLATE utf8mb4_vietnamese_ci,
  `type` enum('fixed','percentage') COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
CREATE TABLE `notifications` (
  ...
  `type` enum('info','success','warning','error') COLLATE utf8mb4_vietnamese_ci DEFAULT 'info',
...
CREATE TABLE `orders` (
  `id` int NOT NULL,
  `user_id` int DEFAULT NULL,
  `order_number` varchar(50) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `status` enum('pending','confirmed','processing','shipped','delivered','cancelled','refunded') COLLATE utf8mb4_vietnamese_ci DEFAULT 'pending',
  `payment_status` enum('pending','paid','failed','refunded','partial_refund') COLLATE utf8mb4_vietnamese_ci DEFAULT 'pending',
...
CREATE TABLE `order_items` (
  ...
  `product_sku` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
CREATE TABLE `permissions` (
  ...
  `name` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `description` text COLLATE utf8mb4_vietnamese_ci,
  `resource` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `action` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
CREATE TABLE `products` (
  ...
  `model` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `sku` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `barcode` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `weight` decimal(8,2) DEFAULT NULL,
  `dimensions` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `warranty_period` int DEFAULT NULL,
  `status` enum('active','inactive','out_of_stock','discontinued') COLLATE utf8mb4_vietnamese_ci DEFAULT 'active',
...
CREATE TABLE `product_images` (
  `id` int NOT NULL,
  `product_id` int DEFAULT NULL,
  `image_url` varchar(500) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
CREATE TABLE `product_specifications` (
  `id` int NOT NULL,
  `product_id` int DEFAULT NULL,
  `spec_name` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `spec_value` text COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `spec_group` varchar(50) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `sort_order` int DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
CREATE TABLE `reviews` (
  ...
  `pros` text COLLATE utf8mb4_vietnamese_ci,
  `cons` text COLLATE utf8mb4_vietnamese_ci,
...
CREATE TABLE `review_images` (
  ...
  `image_url` varchar(500) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `alt_text` varchar(255) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
INSERT INTO `users` (`id`, `email`, `password_hash`, `first_name`, `last_name`, `phone`, `avatar`, `date_of_birth`, `is_active`, `email_verified`, `last_login`, `created_at`, `updated_at`) VALUES
(1, 'admin@electronics.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'System', NULL, NULL, NULL, 1, 1, NULL, '2025-06-12 16:33:25', '2025-06-12 16:33:25');
